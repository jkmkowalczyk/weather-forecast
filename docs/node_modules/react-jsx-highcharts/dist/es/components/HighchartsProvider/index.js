...
export default function provideHighcharts(Component) {
  ...
  var HighchartsWrappedComponent = function HighchartsWrappedComponent(props) {
    ...
    return React.createElement(
      ...
      null,
      function (Highcharts) {
        return React.createElement(Component, _extends({}, props, { getHighcharts: function getHighcharts() {
            return Highcharts;
          } }));
      }
    );
